...
const Homepage = () => {
    return (
        <div>
            <Navbar/>
            <div className="relative w-full overflow-hidden bg-blueZ">
                <div className="mx-auto px-8 sm:px-12 lg:px-16 xl:px-24  max-w-[100rem] w-full relative flex flex-col justify-start items-center gap-8 md:items-start pt-16 md:pt-24 xl:pt-48 md:pb-24 lg:pb-36 xl:pb-60">
                    <div className="w-full sm:w-2/3 md:w-2/4 xl:w-[51%] flex flex-col gap-6 lg:gap-8 text-center md:text-left items-center md:items-start">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="mt-3 text-base lg:text-xl text-blueGray font-normal">Apexpay helps users who have gift cards for sale experience a hassle-free, efficient, and reliable exchange process. Say goodbye to boring gift card exchanges.</p>
                        </div>
                        <div className="flex flex-row max-[375px]:gap-1 max-[360px]:flex-col gap-2">
                            <button className="inline-flex justify-between items-center gap-2 rounded-full border-[1px] py-3 px-4 text-sm sm:text-sm transition-colors font-normal border-blueX text-white hover:border-blueX hover:bg-blueX active:bg-blueX active:text-white">
                            ...
                            <div className="inline-flex justify-between items-center gap-2 rounded-full border border-transparent py-3 px-4 text-sm sm:text-sm font-normal outline-2 outline-offset-2 transition-colors bg-orange text-white hover:bg-zinc-900 hover:border-zinc-600">
            ...
            <div className="bg-zinc-900 py-10 sm:py-16 ">
                <div className="mx-auto px-8 sm:px-12 lg:px-16 xl:px-24  max-w-[100rem] flex flex-col gap-8 lg:gap-10 xl:gap-16">
                    ...
                    <div className="w-full rounded-3xl relative flex flex-col justify-between items-center gap-8 md:items-start px-4 sm:px-8 lg:px-12 py-16 lg:py-28 xl:py-36 bg-cover bg-left-top  md:bg-cover md:bg-center bg-no-repeat bg-darkPurple">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-6 xl:gap-10">
                        <div className="bg-purpleX rounded-3xl p-8 lg:p-8 xl:p-12 flex flex-col gap-4 justify-between lg:gap-8 h-80 lg:h-[22rem] hover:bg-zinc-900 cursor-pointer">
                            <div className="flex flex-col gap-4 lg:gap-8">
                                ...
                                <p className="text-base xl:text-lg text-blueGray font-light">
                        ...
                        <div className="bg-[#1D212C] rounded-3xl p-8 lg:p-8 xl:p-12 flex flex-col gap-4 justify-between lg:gap-8 h-80 lg:h-[22rem] hover:bg-zinc-900 cursor-pointer">
                            <div className="flex flex-col gap-4 lg:gap-8">
                                <h4 className="text-white font-bold text-2xl lg:text-3xl">Unique Deals</h4><p className="text-base xl:text-lg text-blueGray font-light">Get up to 50% extra bonus on your gift card exchange. We make trading gift card as easy and rewarding as possible.</p>
                            </div>
                            <button className="inline-flex justify-between items-center gap-2 rounded-full border border-transparent py-3 px-4 text-sm sm:text-sm font-normal outline-2 outline-offset-2 transition-colors bg-white text-green-600 hover:bg-white/90 w-fit">
                                <span>Get Started</span>
                                <ArrowRight
